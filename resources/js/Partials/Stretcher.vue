<template>
    ...
    <section class="stretcher-wrapper">
        ...
        <ul class="stretcher">
            ...
            <li class="stretcher-item" style="background-image:url(dist/assets/images/gallery-1.jpg);">
                <!--logo-item-->
            ...
            <li class="stretcher-item" style="background-image:url(dist/assets/images/gallery-2.jpg);">
                <!--logo-item-->
                <div class="stretcher-logo">
                    <div class="text">
            ...
            <li class="stretcher-item" style="background-image:url(dist/assets/images/gallery-3.jpg);">
                <!--logo-item-->
                <div class="stretcher-logo">
                    <div class="text">
            ...
            <li class="stretcher-item" style="background-image:url(dist/assets/images/gallery-4.jpg);">
                <!--logo-item-->
                <div class="stretcher-logo">
                    <div class="text">
